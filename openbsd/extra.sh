...
mkdir iso
cd iso
ftp https://ftp2.eu.openbsd.org/pub/OpenBSD/snapshots/amd64/install79.iso

doas pkg_add tor-browser transmission-gtk libreoffice libreoffice-i18n-hu mupdf mpv htop fzf gmake dosbox-x innoextract devilutionx openmw gemrb openwv
